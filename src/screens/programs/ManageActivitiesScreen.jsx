...
import { PlusIcon, DragIcon, TrashIcon, ClockIcon } from '../../components/ui/icons';
  ...
  const fetchProgramDetails = async () => {
    try {
      ...
      if (activitiesData.length === 0) {
        ...
        setActivityStartTime(programData.schedule.startTime);
      } else {
          ...
          onPress={() => {
            Alert.alert(
              ...
              [
                ...
                { text: 'Delete', style: 'destructive', onPress: () => handleDeleteActivity(item.id) }
              ]
            );
          }}
        >
